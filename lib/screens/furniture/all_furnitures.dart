...
class AllFurnitureScreen extends StatelessWidget {
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (snapshot.data!.docs.isEmpty) {
            return Center(
              child: Text("No furnitures found!"),
            );
          }
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                FurnitureModel furnitureModel = FurnitureModel(
                  ...
                  ownerPhoneNumber: productData['ownerPhoneNumber']
                );
                ...
                return Row(
                  children: [
                    GestureDetector(
                      onTap: () => Get.to(() =>
                          FurnitureDetailScreen(furnitureModel: furnitureModel)),
                      child: Padding(
                        ...
                        child: Container(
                          child: FillImageCard(
                            ...
                            imageProvider: CachedNetworkImageProvider(
                              furnitureModel.productImages[0],
                            ),
                            title: Center(
                              child: Text(
                                furnitureModel.productName,
                            ...
                            footer: Center(
                              child: Text("BDT: " + furnitureModel.fullPrice),
                            ),
                          ),
                        ),
                      ),
